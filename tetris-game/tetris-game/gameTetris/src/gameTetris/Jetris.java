...
public class Jetris extends JFrame  implements KeyListener{
	...
	public	void InitMenu(){
		...
		ItemJetrishelp = new JMenuItem("Jetris Help",help);
	...
	public void Resest(){
    	...
    	demI=0;demT=0;demO=0;demL=0;demJ=0;demS=0;demZ=0;
    	lv=1200;
