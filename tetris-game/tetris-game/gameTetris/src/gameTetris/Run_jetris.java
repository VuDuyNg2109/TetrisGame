...
public class Run_jetris extends Thread {
	
	Jetris jt = new Jetris();
			...
			case 0:{
				for(int i=0;i<4;i++){
					...
					if(jt.I.Y[i]+jt.vitri <10 && jt.I.Y[i]+jt.vitri>=0 ){
						...
						jt.cells[jt.a[i]][jt.b[i]].setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
					}jt.anhao();
				}
			...
			case 1:{
				for(int i=0;i<4;i++){
					if(jt.T.Y[i]+jt.vitri <10 && jt.T.Y[i]+jt.vitri>=0){
						...
						jt.cells[jt.T.X[i]+jt.k][jt.T.Y[i]+jt.vitri].setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
					}
			...
			case 2:{
				for(int i=0;i<4;i++){
					if(jt.O.Y[i]+jt.vitri <10 && jt.O.Y[i]+jt.vitri>=0){
						...
						jt.cells[jt.O.X[i]+jt.k][jt.O.Y[i]+jt.vitri].setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
					}
			...
			case 3:{
				for(int i=0;i<4;i++){
					if(jt.L.Y[i]+jt.vitri <10 && jt.L.Y[i]+jt.vitri>=0){
						...
						jt.cells[jt.L.X[i]+jt.k][jt.L.Y[i]+jt.vitri].setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
					}
			...
			case 4:{
				for(int i=0;i<4;i++){
					if(jt.J.Y[i]+jt.vitri <10 && jt.J.Y[i]+jt.vitri>=0 ){
						...
						jt.cells[jt.J.X[i]+jt.k][jt.J.Y[i]+jt.vitri].setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
					}
			...
			case 5:{
				for(int i=0;i<4;i++){
					if(jt.S.Y[i]+jt.vitri <10 && jt.S.Y[i]+jt.vitri>=0 ){
						...
						jt.cells[jt.S.X[i]+jt.k][jt.S.Y[i]+jt.vitri].setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
					}
			...
			case 6:{
				for(int i=0;i<4;i++){
					if(jt.Z.Y[i]+jt.vitri <10 && jt.Z.Y[i]+jt.vitri>=0 ){
						...
						jt.cells[jt.Z.X[i]+jt.k][jt.Z.Y[i]+jt.vitri].setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
					}
			...
			try{	
				...
				for(int i=0;i<4;i++){
					...
					if(kt==true){
						if(jt.a[i]+1>=20)
							stop=false;
						else if((jt.cells[jt.a[i]+1][jt.b[i]].getBackground()!=jt.A)&&(jt.cells[jt.a[i]+1][jt.b[i]].getBackground()!=jt.B)){
							stop=false;
						}
					}
				}
